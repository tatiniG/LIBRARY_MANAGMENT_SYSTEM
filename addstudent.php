...
$nameErr= $pwdErr= $cpwdErr= $contactErr = $mailErr= $mErr= $userErr="";
...
if (isset($_FILES['postimg'])) {
    ...
    if(empty($_POST['username'])){
        ...
        if(strlen ($username)== 9){
            $valid=FALSE;
            $userErr="username must contain atleast 8 characters.";
        }
    }
    ...
    if(empty($_POST['password'])){
        ...
        if(!$uppercase || !$lowercase || !$number || !$specialChars || (strlen($password) > 6 && strlen($password) <= 10)){
            $valid=FALSE;
            $pwdErr="password must contain atleast 6 characters.";
        }
    }
            ...
            <div class="container">
                <form class="form-horizontal" role="form" action="addstudent.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" placeholder="Full name" id="name" ><span id="err"><?php echo $nameErr; ?></span><br>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">Reg No</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="matric_no" placeholder="Registration number" id="password" ><span id="err"><?php echo $mErr; ?></span><br>
                        </div>      
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" name="email" placeholder="Email" id="password" ><span id="err"><?php echo $mailErr; ?></span><br>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">USERNAME</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="username" placeholder="Username" id="password" ><span id="err"><?php echo $userErr; ?></span><br>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">PASSWORD</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="password" placeholder="password" id="password" ><span id="err"><?php echo $pwdErr; ?></span><br>
                        </div>      
                    </div>
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">CONFRIM PASSWORD</label>
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="password2" placeholder="Confirm password" id="password" ><span id="err"><?php echo $cpwdErr; ?></span><br>
                        </div>      
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="phone" placeholder="phone" id="password" ><span id="err"><?php echo $contactErr; ?></span><br>
                        </div>      
                        </div>      
                    </div>     
